...
### Fixed
- **BurnRate: cache read tokens excluded from all calculations** — window utilization, burn rate, budget tracking, and weekly summaries all omitted cache_read_tokens, hiding up to 95% of actual token usage. All four calculation paths now include cache reads.
